...
<%
	...
	int already = (Integer) request.getAttribute("already");
...
<body>
	...
	<section class="project_area section-padding">
		<div class="container">
			<div class="row bigSand_border">
					...
					<div class="blog_left_sidebar">
						<article class="blog_item">
							...
							<img class="card-img rounded-0"
								src="<%=request.getContextPath()%>/WebContent/resources/uploadImages/<%=src%>" />
					...
					<div class="blog_right_sidebar">
						<div class="bigSand_right_profile">
							<div class="bigSand_profile_icon">
								<img src="<%=request.getContextPath()%>/resources/uploadImages/noimage.png"
									alt="">
							</div>
						...
						%>
						<a href="#" id="confirmApply"
							class="bigSand_right_payment bigSand_payment_btn"> 지원자 확인</a>
						<%
							} else {
						%>
						<!-- already = 1 이면 이미 지원한 사람 -->
						<%
							if (already == 1) {
						%>
						<a href="#" class="bigSand_right_payment bigSand_payment_btn">이미
							지원하셨습니다</a>
						<%
							} else {
						%>
						<a href="insertApply?no=<%=projectRead.getProjectNo()%>"
							class="bigSand_right_payment bigSand_payment_btn">지원하기</a>
						<%
							}}
						%>
					</div>
					...
					<div class="bigSand_project_review">
						...
						<div class="bigSand_review">
							...
							<div class="bigSand_review_btns">
								<a href="#" class="bigSand_genric-btn btn2 review_btn">신고</a>
							</div>
				...
				<div
					class="col-lg-12 mb-5 mb-lg-0 bigSand_tm-10 justify-content-center d-flex"></div>
			</div>
	...
	$("#confirmApply").click(function () {
		window.open("<%=request.getContextPath()%>/project/confirmApply?no=<%=projectNo%>", "confirm","width=600, height=300");
	});
