...
<%-- 	<header>
	...
	<section class="project_area section-padding">
		<div class="container">
			<form id="form1" class="bigSand_project_form" method="POST"
				action="<%=request.getContextPath()%>/project/insert_freelancer"
				...
				<div class="row bigSand_border">
					...
					<div class="col-lg-12 mb-5 mb-lg-0">
						<div class="bigSand_project_title bigSand_text text-center">
							<input type="text" class="bigSand_project_inputitle"
								name="projectTitle" placeholder="input Title" required>
						</div>
					</div>
					<!-- Project Title end -->
						...
						<div class="blog_left_sidebar">
							<article class="blog_item">
								<div class="blog_item_img bigSand_project_image_div"
									id="titleImgArea">
									<img id="bigSand_project_image" alt="your image"
										class="card-img rounded-0" width="300" height="352"><br>
									<br> <input type="file" id="fileArea" name="thumbnailImg"
										onchange="LoadImg(this,1)" accept="image/png, image/jpeg"
										id="bigSand_input_imagefile" alt="" required>
								</div>
								...
								<div class="bigSand_project_schedule">
									<div class="bigSand_schedule_wrapper">
										<input type="date" class="bigSand_schedule_dateForm"
											name="projectStartDate" id="bigSand_schedule_start" value=""
											required> <span>~</span> <input type="date"
											class="bigSand_schedule_dateForm" name="projectExpiredDate"
								...
								<div class="bigSand_project_price">
									<div class="bigSand_price_wrapper">
										<span>￦ </span> <input type="number"
											...
											id="bigSand_price_input" value="" placeholder="Insert Price"
											required>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-12 bigSnad_upload_btns">
						<div class="bigSand_comment_btns">
							<!-- <a href="#" class="bigSand_genric-btn btn1 bigSand_upload_btn_resizing">미리보기</a> -->
	...
	<script>
	   ...
	   /*  function  isNull() {
	    	var imgSrc = $("#bigSand_project_image").attr("src").trim();
					...
					<div class="col-xl-4 col-md-6 col-lg-3">
						<div class="footer_widget">
							<div class="footer_logo">
								<a href="#"> <img
									src="<%=request.getContextPath()%>/resources/img/footer_logo.png"
									alt="">
								</a>
							</div>
							<p>
