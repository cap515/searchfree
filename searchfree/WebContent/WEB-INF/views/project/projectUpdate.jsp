...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/css/projectUpload.css">
<link rel="stylesheet"
...
<body>
	...
	<section class="project_area section-padding">
		<div class="container">
			<form id="form1" class="bigSand_project_form" method="POST"
				action="update?no=<%=projectRead.getProjectNo()%>"
				enctype="multipart/form-data">
				<div class="row bigSand_border">
					<!-- Project Title start -->
					<div class="col-lg-12 mb-5 mb-lg-0">
						<div class="bigSand_project_title bigSand_text text-center">
							<input type="text" class="bigSand_project_inputitle"
								name="projectTitle" value="<%=projectRead.getProjectTitle()%>">
						</div>
					</div>
					<!-- Project Title end -->
					<div class="col-lg-7 mb-5 mb-lg-0">
						<div class="blog_left_sidebar">
							<article class="blog_item">
								<div class="blog_item_img bigSand_project_image_div"
									id="titleImgArea">
									<!-- 썸네일 부분 -->
									<%
										String src = "";
									...
									<img class="card-img rounded-0" src="<%=src%>" id="bigSand_project_image"/> 
									<br> <input type="file" id="fileArea" name="thumbnailImg"
										onchange="LoadImg(this,1)" accept="image/png, image/jpeg"
										id="bigSand_input_imagefile" alt="">
								</div>
								<div class="blog_details bigSand_project_explanation">
									<span class="bigSand_project_explanation_text">프로젝트 한줄
										소개</span><br>
									<textarea name="projectSummary" id="" rows="6"><%=projectRead.getProjectSummary()%></textarea>
								</div>
							</article>
						</div>
					</div>
							...
							<div class="bigSand_category">
								<div>
									...
									<div class="bigSand_category_select">
										...
										<select name="inputCategory1" id="inputCategory1"
											class="bigSand_first_category bigSand_category_select_select">
								...
								<div>
									...
									<div class="bigSand_category_select">
										...
										<select name="inputCategory2" id="inputCategory2"
											class="bigSand_second_category bigSand_category_select_select">
											<option value='0'>2차 카테고리 선택</option>
										</select>
									</div>
								</div>
								<!-- <div class="bigSand_project_tag">
                                        <div class="bigSand_project_tag_title">
                                            <span>태그 추가</span>
                                            <button id="bigSand_add_tag" class = "bigSand_add_tag">+</button>
                                        </div>
                                        <input type="text" name="project_tag" class="project_tag" onkeydown="tag_length()">
                                    </div>-->
								<br>
							</div>
								...
								<div class="bigSand_project_schedule">
									<div class="bigSand_schedule_wrapper">
										<input type="date" class="bigSand_schedule_dateForm"
											name="projectStartDate" id="bigSand_schedule_start"
											value="<%=projectStartDate%>"> <span>~</span> <input
											type="date" class="bigSand_schedule_dateForm"
											name="projectExpiredDate" id="bigSand_schedule_start"
											value="<%=projectExpiredDate%>">
									</div>
								</div>
								<div class="bigSand_project_price">
									<div class="bigSand_price_wrapper">
										<span>￦ </span> <input type="number"
											class="bigSand_price_input" name="projectPrice"
											id="bigSand_price_input" value="<%=projectPrice%>">
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-12 mb-5 mb-lg-0">
						...
						<div class="bigSand_summernote_margin">
							...
							<br>
							<!-- summer note start -->
							<textarea name="projectContent" id="summernote"><%=projectRead.getProjectContent()%></textarea>
							<script>
	...
	<script>
		...
		$(function() {
			$("#bigSand_price_input")
					.keydown(
							function() {
								var inputLength = ($("#bigSand_price_input")
										.val().length + 0)
										* 13.3 + "px";
								console.log(inputLength);
								$("#bigSand_price_input").css("width",
										inputLength);
							});
		});
